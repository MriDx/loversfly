...
namespace QuickDate.Activities.Default
{
    ...
    public class RegisterActivity : AppCompatActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private void AddOrRemoveEvent(bool addEvent)
        {
            try
            {
                ...
                if (addEvent)
                {
                    ...
                    //RegisterButton.Touch += GenderEditTextOnTouch; // dont uncomment this line
                    ...
                    {
                        Console.WriteLine("Gender edit text is not null");
                        //GenderEditText.Touch += RegisterButtonOnClick; // dont uncomment this line
                    }
                    else
                    {
                        Console.WriteLine("gender edit text is null");
                    }
        ...
        {
            Console.WriteLine("clicked on gender");
            try
            {
