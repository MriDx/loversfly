    ...
    public class MessagesBoxActivity : AppCompatActivity, IOnClickListenerSelectedMessages
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Methods.CheckConnectivity())
                    {
                        ...
                        PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => MessageController.SendMessageTask(this, Userid, EmojisIconEditTextView.Text, "", "", time2, UserInfoData) }); 
                    }
                    else
                    {
                        Toast.MakeText(this, GetString(Resource.String.Lbl_CheckYourInternetConnection), ToastLength.Short);
        ...
        private void StickerButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ResetButtonTags();
                    StickerButton.Drawable.SetTint(AppSettings.SetTabDarkTheme ? Color.ParseColor("#ffffff") : Color.ParseColor("#424242"));
        ...
        private void GiftButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ResetButtonTags();
                    GiftButton.Drawable.SetTint(AppSettings.SetTabDarkTheme ? Color.ParseColor("#ffffff") : Color.ParseColor("#424242"));
                    //TopFragmentHolder.Animate().SetInterpolator(Interpolation).TranslationY(1200).SetDuration(300);
        ...
        public override void OnBackPressed()
        {
            try
            {
                ...
                if (SupportFragmentManager.BackStackEntryCount > 0)
                {
                    ...
                    ResetButtonTags();
                    StickerButton.Drawable.SetTint(AppSettings.SetTabDarkTheme ? Color.ParseColor("#ffffff") : Color.ParseColor("#888888"));
                    GiftButton.Drawable.SetTint(AppSettings.SetTabDarkTheme ? Color.ParseColor("#ffffff") : Color.ParseColor("#888888"));
